...
//        System.out.println(phone);
        //       System.out.println(map.containsKey(human1));

        PhoneBook newPhoneBook = new PhoneBook();
        newPhoneBook.add("Дятлов", 909333L);
        newPhoneBook.add("Дятлов", 909444L);
        newPhoneBook.add("Петухов", 909555L);
        newPhoneBook.add("Дятлов", 909666L);

        System.out.println(newPhoneBook.get("Дятлов")); // наворот со сканером работает :)
